...
The authoritative label order is [dataset/classes.csv](dataset/classes.csv).
The complete waveform definitions are in
[dataset/docs/DATASET_SPEC.md](dataset/docs/DATASET_SPEC.md).
The exact loop/seed pseudocode is in
[dataset/docs/GENERATION_ALGORITHM.md](dataset/docs/GENERATION_ALGORITHM.md), and
public artifact availability is defined by
[dataset/docs/REPRODUCIBILITY.md](dataset/docs/REPRODUCIBILITY.md).
...
[dataset/docs/PAPER_ALIGNMENT.md](dataset/docs/PAPER_ALIGNMENT.md) for the
per-class evidence.
...
[dataset/docs/PUBLIC_RELEASE.md](dataset/docs/PUBLIC_RELEASE.md). Quantitative
shortcut evidence follows
[dataset/docs/SHORTCUT_AUDIT.md](dataset/docs/SHORTCUT_AUDIT.md).
